...
@section('content')
                            ...
                            @foreach ($langs as $lang)
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteLangModalLabel">Delete Lang</h5>
                                ...
                                <div class="modal fade edit-lang-modal-{{ $lang->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editLangModalLabel">Update Lang</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close">
                                                </button>
                                            </div>
                                                        ...
                                                        <div class="col-md-6 d-flex align-items-end">
                                                            <div class="form-check form-switch mb-3" dir="ltr">
                                                                <label class="form-check-label"
                                                                    for="isPublishedSwitch">Published</label>
    ...
    <div class="modal fade create-lang-modal" tabindex="-1" role="dialog" aria-labelledby="createLangModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createLangModalLabel">Create Lang</h5>
